...
public class Client {
	...
	private static UseRecordedDangerZones useRecordedDangerZones;
	...
	public static void main(String[] args) {
		...
		ParametersContainerE6 para = new ParametersContainerE6(stage, level, useRecordedDangerZones, trackName);
//		para.setUseRecordedDangerZone(useRecordedDangerZones);
//		para.setStage(stage);
//		para.setLevel(level);
	...
	private static void parseParameters(String[] args) {
		...
		useRecordedDangerZones = UseRecordedDangerZones.NOTUSE;
		...
		for (int i = 1; i < args.length; i++) {
			...
			if (entity.equals("DangerMem")) {
				useRecordedDangerZones = UseRecordedDangerZones.fromInt(Integer.parseInt(value));
			}
